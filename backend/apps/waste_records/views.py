...
class ProcessWasteImageView(APIView):
    ...
    def post(self, request):
        ...
        from apps.detection.yolo_service.modular_pipeline import ModularWastePipeline
        gemini_key = request.headers.get("X-Gemini-Key") or request.data.get("gemini_key")
        vision_res = ModularWastePipeline.process_image(waste_image.image.path, custom_api_key=gemini_key)
